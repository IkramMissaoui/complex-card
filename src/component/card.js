...
import './card.css';
import puce from './images/imb.png'
import visa from './images/mcard.png';
...
if(this.state.date.length<=5){
    ...
    render() { 
        ...
        <div className="div1-1">
         ...
         <p className="Number">{this.state.number.padEnd(16, '*').split('').map((x, i) => { return i===4 || i===8  || i===12 ? " " + x : x }).join('')}</p>
        </div>
